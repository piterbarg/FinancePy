...
from financepy.products.rates.ibor_benchmarks_report import ibor_benchmarks_report
...
def test_ibor_benchmarks_report():
    ...
    # return exactly the same keys, just like we want it
    assert bechmarks_report.isnull().values.any() == False
